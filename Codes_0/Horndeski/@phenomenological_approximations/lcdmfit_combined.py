...
Pipeline Flow:
    ...
    4. SECTION 3: Combined plot overlaying LCDM baseline, Model I, and Model II against Combined data.
"""
...
if __name__ == "__main__":
    ...
    out1 = os.path.join(HERE, "outputs_combined_model1")
    ...
    out2 = os.path.join(HERE, "outputs_combined_model2")
    ...
    out_comp = os.path.join(HERE, "outputs_combined_comparison")
    ...
    ax_c.errorbar(z_data, H_data, yerr=sigma_data, fmt="o", ms=4, color="black",
                  ecolor="gray", elinewidth=1, capsize=2, label="Combined Data")
    ...
    ax_c.set_title(r"Combined: Horndeski Model I vs. Model II vs. $\Lambda$CDM", fontsize=12)
