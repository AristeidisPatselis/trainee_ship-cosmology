...
Z_FILE = 'o_z_vals.txt'           # Redshift values
H_FILE = 'o_H_vals.txt'           # H(z) measurements
SIGMA_FILE = 'o_sigma_vals.txt'   # Errors on H(z)
...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), "results_other")
    ...
    literature = {
        "This Work (Other)":     (best_H0, H0_err,   'crimson'),
