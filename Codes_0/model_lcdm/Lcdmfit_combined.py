...
Z_FILE = 'co_z_vals.txt'           # Redshift values
H_FILE = 'co_H_vals.txt'           # H(z) measurements
SIGMA_FILE = 'co_sigma_vals.txt'   # Errors on H(z)
...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), "results_combined")
    ...
    literature = {
        "This Work (Combined Data)":     (best_H0, H0_err,   'crimson'),
