...
Z_FILE = 'd_z_vals.txt'           # Redshift values
H_FILE = 'd_H_vals.txt'           # H(z) measurements
SIGMA_FILE = 'd_sigma_vals.txt'   # Errors on H(z)
...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), "results_desi")
    ...
    literature = {
        "This Work (DESI)":     (best_H0, H0_err,   'crimson'),
